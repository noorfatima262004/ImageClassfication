      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <motion.div
            ...
            className="bg-indigo-600 p-8 rounded-2xl shadow-xl text-white"
          >
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-1 text-indigo-100">+92 (555) 123-4597</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-1 text-indigo-100">noorfatima@gmail.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-1 text-indigo-100">DHA, Phase 6<br />Lahore, Pakistan</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8">
              ...
              <div className="flex space-x-4">
                <motion.a
                  href="#"
                  whileHover={{ y: -2 }}
                  className="bg-indigo-500 p-3 rounded-full hover:bg-indigo-400 transition-colors duration-300"
                >
